...
```bash
# 0. Download ubuntu-25.10-netboot-amd64.tar.gz
...
Files are fetched from Ubuntu's official releases mirror:
- `https://releases.ubuntu.com/${UBUNTU_VERSION}/ubuntu-${UBUNTU_VERSION}-netboot-amd64.tar.gz`
